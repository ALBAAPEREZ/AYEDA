...
int main(int argc, char* argv[]) {
  ...
  // IMPRIMIR RESULTADOS MODIFICACION
  int count;
  std::cout << "\n+----------------+----------------+----------------+\n";
  std::cout << "| Método         | Tamaño         | Comparaciones  |\n";
  std::cout << "+-----------------+----------------+----------------+\n";
  
  // Prueba 1: SelectionSort con tamaño 100
  options.ordenationType = "SelectionSort"; 
  options.sequenceSize = 100;
  std::cout << "| " << std::setw(14) << std::left << options.ordenationType
            << "| " << std::setw(14) << std::left << options.sequenceSize
            << "| " << std::setw(14) << std::left << count << "|\n";

  // Prueba 2: SelectionSort con tamaño 1000
  options.sequenceSize = 1000;
  std::cout << "| " << std::setw(14) << std::left << options.ordenationType
            << "| " << std::setw(14) << std::left << options.sequenceSize
            << "| " << std::setw(14) << std::left << count << "|\n";

  // Prueba 3: QuickSort con tamaño 100
  options.ordenationType = "QuickSort";
  options.sequenceSize = 100;
  std::cout << "| " << std::setw(14) << std::left << options.ordenationType
            << "| " << std::setw(14) << std::left << options.sequenceSize
            << "| " << std::setw(14) << std::left << count << "|\n";

  // Prueba 4: QuickSort con tamaño 1000
  options.sequenceSize = 1000;
  std::cout << "| " << std::setw(14) << std::left << options.ordenationType
            << "| " << std::setw(14) << std::left << options.sequenceSize
            << "| " << std::setw(14) << std::left << count << "|\n";
